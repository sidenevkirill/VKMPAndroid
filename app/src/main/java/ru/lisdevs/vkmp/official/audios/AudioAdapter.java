...
import ru.lisdevs.vkmp.model.Message;
import ru.lisdevs.vkmp.utils.TokenManager;

public class AudioAdapter extends RecyclerView.Adapter<AudioAdapter.ViewHolder> {

    private List<ru.lisdevs.vkmp.official.audios.Audio> audioList;
    ...
    public AudioAdapter(List<ru.lisdevs.vkmp.official.audios.Audio> audioList, Context context) {
    ...
    private void showPopupMenu(View view, ru.lisdevs.vkmp.official.audios.Audio audio, int position) {
    ...
    private void shareAudioToChat(ru.lisdevs.vkmp.official.audios.Audio audio) {
        if (availableChats.isEmpty()) {
            Toast.makeText(context, "Список диалогов пуст", Toast.LENGTH_SHORT).show();
            return;
        }

        ru.lisdevs.vkmp.official.audios.ShareAudioBottomSheet bottomSheet = ru.lisdevs.vkmp.official.audios.ShareAudioBottomSheet.newInstance(
                audio,
    ...
    private void sendAudioToChat(Message chat, ru.lisdevs.vkmp.official.audios.Audio audio) {
    ...
    private void copyAudioUrl(ru.lisdevs.vkmp.official.audios.Audio audio) {
    ...
    private void shareAudioUrl(ru.lisdevs.vkmp.official.audios.Audio audio) {
        String audioUrl = audio.getUrl();
        if (audioUrl != null && !audioUrl.isEmpty() && !audioUrl.equals("null")) {
