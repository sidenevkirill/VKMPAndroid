...
public class Message implements Parcelable {
    ...
    private int unreadCount; // Новое поле для количества непрочитанных сообщений
    ...
    protected Message(Parcel in) {
        ...
        unreadCount = in.readInt(); // Чтение unreadCount
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(unreadCount); // Запись unreadCount
    }
    ...
    // Геттер и сеттер для unreadCount
    ...
    private String generateAttachmentPreview() {
        ...
        int otherCount = getAttachmentCount() - photoCount - docCount - audioCount - audioMessageCount - stickerCount;
    ...
    public boolean isIncoming() {
        return readStatus == READ_STATUS_INCOMING;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (isOutgoing != message.isOutgoing) return false;
    ...
    // Builder pattern для удобного создания сообщений
    ...
    // Статические методы-хелперы для создания сообщений
